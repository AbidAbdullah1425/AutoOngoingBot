...
MAIN_CHANNEL = int(os.environ.get("MAIN_CHANNEL", "-1002386614375"))
ANILIST_API = os.environ.get("ANILIST_API", "https://graphql.anilist.co")
...
DB_NAME = os.environ.get("DB_NAME", "CrispAnime")
...
HUGGINGFACE_URL = os.environ.get("HUGGINGFACE_URL", "https://abidabdullah199-CompressorHelper.hf.space/")
